...
return array(
    ...
    'sf_available' => array(
        ...
        'description'      => 'Если опция включена, при фильтрации будут отображаться только товары в наличии вне зазвисимости от соответствующей настройки на уровне категории.',
        'control_type'     => waHtmlControl::CHECKBOX,
    ),
    'max_count' => array(
        'value'            => '0',
